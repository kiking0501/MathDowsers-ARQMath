...
import csv
import sys
from utility.dao import clean_escape_html
...
def read_formula_tsv_by_path(tsv_path, groupby_list, html_escape=False):
    """
        Read a formula tsv file by the input tsv_path
